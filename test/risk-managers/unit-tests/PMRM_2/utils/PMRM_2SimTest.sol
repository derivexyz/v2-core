...
contract PMRM_2SimTest is PMRM_2TestBase {
    ...
    returns (ISubAccounts.AssetBalance[] memory balances)
  {
    ...
    string memory json = JsonMechIO.jsonFromRelPath("/test/risk-managers/unit-tests/PMRM_2/testScenarios.json");
    ...
    returns (ISubAccounts.AssetBalance[] memory balances)
  {
    ...
    pmrm_2.setBalances(aliceAcc, balances);
