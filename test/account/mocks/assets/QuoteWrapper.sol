...
contract QuoteWrapper is IAsset, Owned {
    ...
    function setManagerAllowed(IManager riskModel, bool allowed)
        external
        onlyOwner
    {
    ...
    function deposit(uint256 recipientAccount, uint256 amount) external {
    ...
    function handleManagerChange(uint256, IManager) external pure override {}
}
